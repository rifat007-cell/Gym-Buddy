export const Passkeys = {
  register: async (username) => {
    try {
      ...
      const response = await fetch(
        "http://localhost:4000/api/passkey/registration-begin",
        {
          method: "POST",
          headers: {
      ...
      const verificationResponse = await fetch(
        "http://localhost:4000/api/passkey/registration-end",
        {
          method: "POST",
  ...
  authenticate: async (email) => {
    try {
      ...
      const response = await fetch(
        "http://localhost:4000/api/passkey/authentication-begin",
        {
          method: "POST",
      ...
      const verificationResponse = await fetch(
        "http://localhost:4000/api/passkey/authentication-end",
        {
          method: "POST",
          credentials: "same-origin",
          headers: {
